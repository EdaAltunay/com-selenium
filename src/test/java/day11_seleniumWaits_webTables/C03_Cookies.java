...
public class C03_Cookies extends TestBase {
    ...
    public void test01(){
        ...
        cookiesSet = driver.manage().getCookies();  // setimize son cookies i ekledik.
        ...
        siraNo=1;
        cookiesSet = driver.manage().getCookies();  // silinen cookie icin setimizi guncelledik.
        ...
        cookiesSet = driver.manage().getCookies(); // setimzi guncelledik
